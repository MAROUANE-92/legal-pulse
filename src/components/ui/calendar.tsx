    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-background p-0 opacity-50 hover:opacity-100 border-border"
        ),
        ...
        dropdown: "absolute z-10 text-sm bg-popover border border-border rounded-md shadow-md p-1",
        dropdown_month: "w-32",
        dropdown_year: "w-20",
        ...classNames,
      }}
