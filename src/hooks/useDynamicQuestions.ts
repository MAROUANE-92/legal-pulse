...
import { MOTIF_QUESTIONS, GLOBAL_QUESTIONS, Question } from "@/lib/questions.config";
...
export function getTooltipForQuestion(id: string): string {
  const tooltips: Record<string, string> = {
    ...
    "H10_actualHours": "Horaires réellement pratiqués en moyenne",
    ...
    "L9_STC": "Document de fin de contrat récapitulant les sommes dues",
    ...
    "E1_channels": "Moyens de communication utilisés pour échanger avec l'employeur"
  };
  return tooltips[id] || "";
}
